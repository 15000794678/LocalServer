...
namespace HalconATE
{
    public class Phicomm
    {
        private string boxModelPath = @"\model\lusen\surebox.ncm";
        private string rightModelPath = @"\model\lusen\rightResult.ncm";
        private string testModelPath = @"\model\lusen\testover.ncm";

        private string dirPath = string.Empty;

        private TestDLL.HalconBoardTestDll _testDll = new TestDLL.HalconBoardTestDll();
        /*
         * 返回值 ：
         * 000 = 代表三个都齐全；
         * 111 = 代表全没有，
